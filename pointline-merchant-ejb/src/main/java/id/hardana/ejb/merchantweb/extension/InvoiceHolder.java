...
public class InvoiceHolder {
    ...
    public InvoiceHolder(Long id, String number, BigDecimal amount, Date dateTime,
            ...
            String outletName, double outletLatitude, double outletLongitude, String invoiceNumberReference) {
        this.id = id;
        this.number = number;
        this.amount = amount;
        ...
        this.invoiceNumberReference = invoiceNumberReference;
    }
    ...
    public String getInvoiceNumberReference() {
        return invoiceNumberReference;
    }

    public void setInvoiceNumberReference(String invoiceNumberReference) {
        this.invoiceNumberReference = invoiceNumberReference;
    }

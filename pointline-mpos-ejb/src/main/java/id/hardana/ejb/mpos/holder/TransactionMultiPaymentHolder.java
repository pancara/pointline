...
public class TransactionMultiPaymentHolder {
    ...
    private BigDecimal balanceAfterDebet;
    //Response
    ...
    public BigDecimal getBalanceAfterDebet() {
        return balanceAfterDebet;
    }

    public void setBalanceAfterDebet(BigDecimal balanceAfterDebet) {
        this.balanceAfterDebet = balanceAfterDebet;
    }

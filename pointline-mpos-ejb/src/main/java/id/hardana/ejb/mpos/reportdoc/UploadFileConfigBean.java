...
import id.hardana.entity.document.MposConfigDocument;
...
public class UploadFileConfigBean {
    ...
    public JSONObject insertFileConfig(String merchantCode, String userName, String outletId, String fileName, String filePath) {
        ...
        MposConfigDocument configDocument = new MposConfigDocument();
        configDocument.setMerchantId(merchantId);
        configDocument.setUpdatedBy(operatorId);
        configDocument.setOutletId(outletIdLong);
        configDocument.setFileName(fileName);      
        configDocument.setLastUpdated(nowDate);
        configDocument.setFilePath(filePath);

        em.persist(configDocument);

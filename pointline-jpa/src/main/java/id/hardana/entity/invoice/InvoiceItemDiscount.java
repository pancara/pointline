 ...
 */
@Entity
@Table(name = "invoiceitemdiscount")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "InvoiceItemDiscount.findByInvoiceItemId", query = "SELECT i FROM InvoiceItemDiscount i WHERE i.invoiceItemId = :invoiceItemId"),
    })

public class InvoiceItemDiscount implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof InvoiceItemDiscount)) {
            return false;
        }
        InvoiceItemDiscount other = (InvoiceItemDiscount) object;
    ...
    public String toString() {
        return "InvoiceItemDiscount{" + "id=" + id + ", invoiceItemId=" + invoiceItemId + ", discountId=" + discountId + ", discountName=" + discountName + ", discountDescription=" + discountDescription + ", discountValue=" + discountValue + ", discountValueType=" + discountValueType + ", discountCalculationType=" + discountCalculationType + ", discountApplyType=" + discountApplyType + ", discountAmount=" + discountAmount + '}';
    }

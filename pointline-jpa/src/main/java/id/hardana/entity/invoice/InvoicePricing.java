 ...
 */
@Entity
@Table(name = "invoicepricing")
@XmlRootElement
@NamedQueries({
        @NamedQuery(name = "InvoicePricing.findAll", query = "SELECT i FROM InvoicePricing i"),
        @NamedQuery(name = "InvoicePricing.findByInvoiceId", query = "SELECT i FROM InvoicePricing i WHERE i.invoiceId = :invoiceId"),
        @NamedQuery(name = "InvoicePricing.findById", query = "SELECT i FROM InvoicePricing i WHERE i.id = :id")})
public class InvoicePricing implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof InvoicePricing)) {
            return false;
        }
        InvoicePricing other = (InvoicePricing) object;
    ...
    public String toString() {
        return "id.hardana.entity.transaction.InvoicePricing[ id=" + id + " ]";
    }

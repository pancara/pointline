 ...
 */
@Entity
@Table(name = "paterninvoicetransactiondiscount")
public class PaternInvoiceTransactionDiscount implements Serializable {
    ...
    public PaternInvoiceTransactionDiscount() {
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PaternInvoiceTransactionDiscount)) {
            return false;
        }
        PaternInvoiceTransactionDiscount other = (PaternInvoiceTransactionDiscount) object;

...
package id.hardana.entity.sys.log;
  ...
  */
 @Entity
 @Table(name = "loginadmindetail")
 @XmlRootElement
 public class LoginAdminDetail implements Serializable {
     ...
     public boolean equals(Object object) {
         ...
         if (!(object instanceof LoginAdminDetail)) {
             return false;
         }
         LoginAdminDetail other = (LoginAdminDetail) object;
         return !((this.id == null && other.id != null) || (this.id != null && !this.id.equals(other.id)));
     }

     @Override
     public String toString() {
         return "id.hardana.entity.api.LoginAdminDetail[ id=" + id + " ]";
     }

 ...
 * @author Trisna
 */
public class BillMerchantReportHolder {
    ...
    public BillMerchantReportHolder(String billNumber, String billName,
            ...
            String payerLastName, String invoiceNumber, BillRejectReasonEnum payerRejectReason,
            String payerRejectDesc, TransactionPaymentTypeEnum paymentType) {
